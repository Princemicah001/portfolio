      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {/* Resume Preview */}
            <Reveal className="lg:col-span-2" data-oppose="left">
              <Card className="p-8 rounded-3xl shadow-medium space-y-8">
                {/* Experience */}
                <div>
              ...
              <Reveal data-oppose="right">
                <Card className="p-6 rounded-3xl shadow-medium space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Request an updated PDF for complete project details and references.
                    </p>
                  </div>
                </Card>
              </Reveal>
